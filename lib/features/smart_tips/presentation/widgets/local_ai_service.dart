...
class LocalAiService {
 ...
 bool get isModelReady => _isModelReady;
  ...
  Future<String> summarizeArticle(String title,String content) async{
    if(!_isModelReady|| _activeChat == null) {return "AI  Model is loading offline data...";}
    try{
      final prompt = "You are a poultry expert assistant. Summarize this African poultry news article in 2 bullet points.\nTitle: $title\nContent: $content";
